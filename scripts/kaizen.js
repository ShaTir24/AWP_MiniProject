document.addEventListener('DOMContentLoaded', () => {
    ...
    submitButton.addEventListener('click', () => {
        ...
        const winner_file =JSON.stringify(winnerCertificate.files[0]);
        const participation_file =JSON.stringify(partcipationCertificate.files[0]);
        const report_file =JSON.stringify(projectReport.files[0]);
